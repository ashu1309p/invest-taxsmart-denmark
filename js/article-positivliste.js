...
(function () {
  ...
  var PAGE_I18N = {
    en: {
      ...
      "art_pos_isin_p2":"Always check the exact ISIN of the share class you actually intend to buy, before you buy. You can paste it straight into the ISIN checker on the Plan page.",
      ...
      "art_pos_ta3":"It works per ISIN, so every share class differs — check the exact one.",
    ...
    da: {
      ...
      "art_pos_isin_p2":"Tjek altid det præcise ISIN på den andelsklasse, du faktisk vil købe, før du køber. Du kan indsætte det direkte i ISIN-tjekkeren på Planlæg-siden.",
      ...
      "art_pos_ta3":"Det gælder pr. ISIN, så hver andelsklasse er forskellig — tjek den præcise.",
